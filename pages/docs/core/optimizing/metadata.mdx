...
<Tabs items={["TypeScript", "JavaScript"]}>
  <Tabs.Tab>
    ```typescript filename="src/pages/home.page.tsx" {36} showLineNumbers copy
  ...
  <Tabs.Tab>
    ```javascript filename="src/pages/home.page.jsx" {36} showLineNumbers copy
    import { Metadata, defineRoutePage } from "rasengan";
...
<AlertBox type="tip">
`href` can be an absolute path of the icon you want to display, or also a relative path to the one stored inside the [`public`](/docs/core/optimizing/static-assets) directory
</AlertBox>
