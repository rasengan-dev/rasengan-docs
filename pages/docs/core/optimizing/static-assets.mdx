---
title: "Optimizing: Static Assets"
description: "Learn how to serve static assets in Rasengan.js."
---
...
<AlertBox>
  The name of the folder has to be named `public`. The files inside `public` are
  served as-is. After the build, the files in the `public` folder are available
...
<Container>
  <NextStepCard
    ...
    link="/docs/core/configuring/typescript"
  />
</Container>
