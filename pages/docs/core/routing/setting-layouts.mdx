...
<Tabs items={['TypeScript', 'JavaScript']} defaultIndex="1">
  <Tabs.Tab>
    ```typescript filename="src/app/app.layout.tsx" showLineNumbers copy
  ...
  <Tabs.Tab>
    ```javascript filename="src/app/app.layout.jsx" showLineNumbers copy
    import React from "react";
    import { LayoutComponent, Outlet, defineRouteLayout } from "rasengan";
...
<Tabs items={['TypeScript', 'JavaScript']} defaultIndex="1">
  <Tabs.Tab>
    ```typescript filename="src/app/admin.layout.tsx" showLineNumbers copy
    import React from "react";
    import { LayoutComponent, Outlet, defineRouteLayout } from "rasengan";
  ...
  <Tabs.Tab>
    ```javascript filename="src/app/admin.layout.jsx" showLineNumbers copy
    import React from "react";
    import { LayoutComponent, Outlet, defineRouteLayout } from "rasengan";
...
<Tabs items={['TypeScript', 'JavaScript']} defaultIndex="1">
  <Tabs.Tab>
    ```typescript filename="src/app/dashboard.page.tsx" showLineNumbers copy
    import React from "react";
  ...
  <Tabs.Tab>
    ```javascript filename="src/app/dashboard.page.jsx" showLineNumbers copy
    import React from "react";
    import { PageComponent, defineRoutePage } from "rasengan";
