...
<Tabs items={['TypeScript', 'JavaScript']} defaultIndex="1">
  <Tabs.Tab>
    ```tsx filename="src/pages/profile.page.tsx" {5,10,14} showLineNumbers /useParams/  copy
  ...
  <Tabs.Tab>
    ```tsx filename="src/pages/profile.page.jsx" {5,10,14} showLineNumbers /useParams/  copy
    import { PageComponent, defineRoutePage, useParams } from "rasengan";
