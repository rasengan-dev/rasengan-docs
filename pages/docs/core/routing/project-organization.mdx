...
- [`main.js`](/docs/api-reference/file-conventions/main): This file is the entry point of your project. It is the first file that is executed when your project starts.
- [`app/app.router.js`](/docs/api-reference/file-conventions/router): This file is the main router of your project. It is the file that contains the routes of your project.
