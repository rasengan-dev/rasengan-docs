...
<Tabs items={['TypeScript', 'JavaScript']} defaultIndex="1">
  <Tabs.Tab>
    ```tsx filename="src/pages/_404.tsx" showLineNumbers copy
  ...
  <Tabs.Tab>
    ```tsx filename="src/pages/_404.jsx" showLineNumbers copy
    import { Link } from "rasengan";
...
<Tabs items={['TypeScript', 'JavaScript']} defaultIndex="1">
  <Tabs.Tab>
    ```typescript filename="src/pages/app.router.ts" {4,12} showLineNumbers copy
  ...
  <Tabs.Tab>
    ```typescript filename="src/pages/app.router.js" {4,12} showLineNumbers copy
    import { RouterComponent, defineRouter } from "rasengan";
    import Home from "@/pages/home.page";
    import AppLayout from "@/pages/app.layout";
    import NotFound from "@/pages/_404";
