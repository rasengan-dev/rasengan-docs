...
description: Overview of how a Rasengan.js project is structured.
---
...
<AlertBox type="tip">
  You can organize the `pages`, `routers` and `layouts` as you want in
  subfolders, but please, keep the convention of the file name.
</AlertBox>
<AlertBox>
  The `app.router` file is **required** for defining routing into your app and
  should be present in the `app` folder.
</AlertBox>
