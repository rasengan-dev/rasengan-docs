...
<AlertBox type="info">
The `app.router.js` file is required and have to be located in the `pages` directory, because it's used by Rasengan.js to define routing for your app automatically.
</AlertBox>
...
```javascript filename="main.js" showLineNumbers copy
