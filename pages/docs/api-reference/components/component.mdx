---
title: 'API Reference: Component React component'
description: 'The `Component` React component is the main component provided by Rasengan.js to setting up all the routing system based on the `AppRouter` that it receives as a prop. This component is used inside the `main.tsx` file (the entry point of the application) to set up the routing system'
---
